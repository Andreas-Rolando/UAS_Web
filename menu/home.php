...
<html>
  <head>
    <meta charset="UTF-8">
    <title>KAS RT 08 | Dashboard</title>
 ...
 <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="callout callout-info">
            <h4>Announcement!!</h4>
            <p><b>Aplikasi KAS RT 08 dibuat untuk mempermudah administrasi kas RT 08</a></p>
          </div>
        </div>
        <!-- /.col -->
      </div>
                ...
                <dd>
                  <ol>
                   ...
                   Info lebih lanjut mengenai aplikasi:
                    <ul>
                        <li><a href="https://api.whatsapp.com/send?phone=6281575835002" target="blank"><i class="fa fa-whatsapp"></i> : 081575835002</a></li>
                        <li><a href="mailto:andreasrolando83@gmail.com"><i class="fa fa-envelope-o"></i> : andreasrolando83@gmail.com</a></li>
                    </ul>
                    <p style="text-align: center">~<i> Andreas Rolando </i><i class="fa fa-smile-o"></i>  ~</p>
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
    ...
    <!-- /.content -->
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2022 Kas RT 08.</strong> 
      </footer>
